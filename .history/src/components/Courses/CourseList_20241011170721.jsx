            ...
            <div className="col-md-6 mb-4" key={course.id}>
              <div className="card shadow">
                ...
                <div className="card-body">
                  <p>
                    <strong>Départ :</strong> {course.adresse_depart}
                  </p>
                  <p>
                    <strong>Arrivée :</strong> {course.adresse_arrivee}
                  </p>
                  <p>
                    <strong>Statut :</strong>{' '}
                    <span className={`badge bg-${course.statut === 'en attente' ? 'warning' : course.statut === 'en cours' ? 'primary' : 'success'}`}>
                      {course.statut}
                    </span>
                  </p>
                </div>
